...
| `rados-cls` | Client-side encodings for Ceph object classes (`version`, `refcount`, `user`, `queue`, `rgw`, `rgw_gc`, `lock`), one module per class behind a feature of the same name. |
